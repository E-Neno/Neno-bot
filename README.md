...
Neno 的身份从世界引擎长出来，不在聊天 prompt 里写死（刀①「她自己活成自己」，详见 `docs/living-world.md` §5b/§5c）：
...
- **自我库**：她反复做的事、主动学的东西，会经反思结晶成 `subject="neno"` 的自我事实（偏好/在学的事），慢慢沉淀成「她是谁」——只能从真发生过的经历来，聊天写不进（防伪）。
- **意图通道**：你的话会变成她的「意图候选」，由世界引擎临场决定做不做——她可能去做，也可能没空/不想（无常）。你是她世界的一部分，不是发指令的人。
